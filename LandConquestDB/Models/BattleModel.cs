...
namespace LandConquestDB.Models
{
    public class BattleModel
    {
        ...
        public static List<ArmyInBattle> GetArmiesInfoInCurrentTile(War war, int index)
        {
            return DbContext.GetSqlConnection().Query<ArmyInBattle>("SELECT * FROM dbo.ArmyDataInBattle WHERE war_id = @war_id AND local_land_id = @local_land_id", new { war_id = war.WarId, local_land_id = index }).ToList();
        }
